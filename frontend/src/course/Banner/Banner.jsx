              ...
              {[
                {
                  ...
                  description: "Certified professionals guiding your personalized fitness path.",
                  color: "from-green-400 to-teal-400",
                },
                {
                  icon: "fa-dumbbell",
                  title: "Diverse Classes",
                  description: "Over 50 specialized courses from cardio to strength training.",
                  color: "from-blue-400 to-indigo-400",
                },
                {
                  icon: "fa-clock-o",
                  title: "Flexible Schedule",
                  description: "Classes all day, every day — fit your workout seamlessly.",
                  color: "from-purple-400 to-pink-400",
                },
                {
                  icon: "fa-star",
                  title: "Premium Facilities",
                  description: "Modern gyms and relaxing spa amenities to enhance your wellness.",
                ...
                <div
                  ...
                  className={`bg-white/10 dark:bg-[#424242] p-6 rounded-xl border border-gray-200 dark:border-white/10 shadow-md 
                    ${expandedCard === index ? "scale-105 z-10 col-span-full" : "hover:scale-[1.02]"}
                    transition-transform duration-300 cursor-pointer`}
                >
                  <div className="flex items-start gap-4">
                    <div
                      className={`w-14 h-14 rounded-xl bg-gradient-to-br ${card.color} flex items-center justify-center flex-shrink-0`}
                    >
                      <i className={`fa ${card.icon} text-white text-2xl`}></i>
                    </div>
                    <div>
                      <h3 className="text-gray-800 dark:text-white font-extrabold text-2xl mb-2">
                        {card.title}
                      </h3>
                      <p className="text-gray-600 dark:text-white/80 text-base leading-relaxed font-medium">
                        {expandedCard === index
                          ? card.description +
                  ...
                  {expandedCard === index && (
                    <div className="mt-4 pt-4 border-t border-gray-300 dark:border-white/10">
                      <p className="text-gray-700 dark:text-white/70 text-base font-normal">
                        Our certified trainers bring years of experience and dedication to help you reach your goals through tailored programs, group classes, and nutritional support.
                      </p>
                    </div>
                  )}
                </div>
